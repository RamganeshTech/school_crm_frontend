...
//   size?: 'sm' | 'md' | 'lg' | 'icon';
//   isLoading?: boolean;
//   leftIcon?: string; // FontAwesome class, e.g., "fa-solid fa-plus"
//   rightIcon?: string;
//   fullWidth?: boolean;
// }
...
//   ...props
// }, ref) => {
//   const baseStyles = "inline-flex items-center justify-center font-medium transition-all duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-soft disabled:opacity-60 disabled:cursor-not-allowed";
  
//   const variants = {
//     primary: "bg-primary text-white hover:bg-primary-hover shadow-sm",
//     secondary: "bg-primary-soft text-primary hover:bg-primary hover:text-white",
...
//     danger: "bg-red-50 text-red-600 hover:bg-red-600 hover:text-white border border-red-200", // Exception for semantic danger
//   };
