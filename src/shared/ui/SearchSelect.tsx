...
interface SearchSelectProps {
  ...
  placeholder?: string;
  isClearable?: boolean; // 🌟 1. Add the new prop here
  label?: string;
}
...
export const SearchSelect: React.FC<SearchSelectProps> = ({
  ...
  placeholder = "Search...",
  label,
  isClearable = true, // 🌟 2. Default to true so it doesn't break other pages
  ...props
}) => {
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      <Input
        ...
        // 🌟 3. Update rightIcon to check BOTH value AND isClearable
        rightIcon={
          value && isClearable
            ? "fa-solid fa-xmark cursor-pointer hover:text-red-500"
            : (isOpen ? "fa-solid fa-chevron-up" : "fa-solid fa-chevron-down")
        ...
        // 🌟 4. Update the click handler logic
        onRightIconClick={(value && isClearable) ? handleClear : () => setIsOpen(!isOpen)}
