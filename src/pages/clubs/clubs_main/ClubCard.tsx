        ...
        <div className="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
            ...
            >
                ...
                <div className="relative h-40 w-full bg-gray-50 border-b border-gray-100 overflow-hidden flex-shrink-0">
                    ...
                    <div className="absolute top-3 left-3">
                        <span className={`px-2 py-1 text-[9px] font-bold uppercase tracking-wider rounded border bg-white/95 backdrop-blur-sm shadow-sm ${
                            club.isActive 
            ...
            {isAdmin && (
                <div className="border-t border-gray-100 bg-white flex items-center justify-around py-3 px-2">
                    ...
                    <button 
                        onClick={() => onView(club._id)}
                        className="flex flex-col items-center justify-center gap-1 text-blue-500 hover:text-blue-700 transition-colors bg-transparent"
                    >
                    ...
                    <button 
                        onClick={() => onEdit(club)}
                        className="flex flex-col items-center justify-center gap-1 text-gray-500 hover:text-gray-800 transition-colors bg-transparent border-l border-gray-100 pl-4"
                    >
                    ...
                    <button 
                        ...
                        disabled={isDeleting}
                        className="flex flex-col items-center justify-center gap-1 text-rose-500 hover:text-rose-700 transition-colors bg-transparent border-l border-gray-100 pl-4"
                    >
                        {isDeleting ? (
