...
export default function AnnouncementMain() {
    ...
    //         {/* HEADER */}
    //         <header className="shrink-0 px-6 py-2 border-b border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-surface z-10">
    //             <div>
    ...
    //                                                 <span className="text-xs font-bold text-muted gap-1.5">
    //                                                     <i className="fas fa-paperclip"></i> {item.attachments.length || 0}
    //                                                 </span>
    //                                             ) : (
    //                                                 <span className="text-xs text-primary-hover !text-center ">____</span>
    //                                             )}
    //                                         </Td>
