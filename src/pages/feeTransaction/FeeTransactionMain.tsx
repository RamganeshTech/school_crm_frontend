...
//     // 1. Extract IDs from the nested Route: /student-record/single/:studentId/fee-transaction/:studentId
//     // We only need studentId for fetching the list, but both are available if needed.
//     const { studentId } = useParams<{ studentId: string; studentId: string }>();

//     // 2. Table State: Fetch all transactions for this specific student record
//     const { 
//         data: transactions, 
//         isLoading, 
//         isError 
...
//     // 3. Modal State: Handle viewing a single transaction
...
//         // Small timeout to let the close animation finish before clearing the data, preventing UI flashes
//         setTimeout(() => setSelectedTxnId(null), 300);
//     };

//     // --- Helpers ---
//     // Beautifully formats the status into a colored pill badge
...
//             {/* --- HEADER --- */}
//             <div className="flex justify-between items-center bg-surface p-5 rounded-xl border border-border shadow-sm shrink-0">
//                 <div>
//                     <h2 className="text-lg font-bold text-foreground flex items-center gap-2">
//                         <i className="fas fa-file-invoice-dollar text-primary"></i>
//                         Fee Transactions
//                     </h2>
//                     <p className="text-xs text-muted mt-1">Payment history and receipts for this academic record.</p>
//                 </div>
//                 {/* Optional: Add a 'Record Payment' button here later if needed */}
//             </div>
...
//                             ) : isError ? (
//                                 <tr>
//                                     <td colSpan={6} className="py-20 text-center text-danger bg-danger/5">
...
//                                 <tr>
//                                     <td colSpan={6} className="py-24 text-center text-muted flex flex-col items-center">
...
//                                         <p className="text-xs mt-1">There are no fee records available for this student.</p>
//                                     </td>
//                                 </tr>
//                             ) : (
...
//                                     {/* Conditional Render for Cheque/Bank Transfer Info */}
...
//                             {/* 3. Fee Allocation Breakdown (What they actually paid for) */}
...
//                             {/* 5. Cash Denominations (If Cash Payment) */}
