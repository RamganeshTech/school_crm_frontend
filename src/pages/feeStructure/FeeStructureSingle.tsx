...
export default function FeeStructureSingle() {
    ...
    return (
        <div className="w-full h-full flex flex-col bg-background overflow-hidden">
            ...
            <header className="shrink-0 px-4 sm:px-6 py-4 sm:py-5 border-b border-border flex items-center justify-between bg-surface z-10 shadow-sm">
            ...
            <main className="flex-1 overflow-y-auto p-3 sm:p-6 md:p-8 custom-scrollbar">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex bg-surface p-1 rounded-xl border border-border shadow-sm mb-4 sm:mb-6 w-full max-w-md mx-auto md:mx-0">
                        <button 
                            onClick={() => setActiveTab('new')}
                            className={`flex-1 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold transition-all cursor-pointer ${
                                activeTab === 'new' ? 'bg-primary-soft text-primary shadow-sm' : 'text-muted hover:bg-sub-header'
                            }`}
                        >
