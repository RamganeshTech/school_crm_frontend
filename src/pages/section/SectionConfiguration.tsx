...
// import { SearchSelect, SelectOption } from '../../shared/ui/SearchSelect'; // 🛑 Added Import
...
//         refetch 
//     } = useGetSections({ schoolId: schoolId!, classId: selectedClassId });
...
//     // 🛑 Format classes for the SearchSelect component
...
//                     {/* 🛑 Replaced native select with Custom SearchSelect */}
...
//                         <THead className="sticky top-0 z-10 bg-background after:absolute after:bottom-0 after:left-0 after:right-0 after:border-b after:border-divider">
//                             <tr>
...
//                 )
//             ) : (
//                 /* Primary Empty State (No Sections in Class) */
//                 <div className="flex flex-col items-center justify-center py-16 px-4 text-center bg-surface border border-divider rounded-xl shadow-sm">
//                     <div className="w-16 h-16 rounded-full bg-background border border-border flex items-center justify-center mb-4 text-muted text-2xl shadow-sm">
